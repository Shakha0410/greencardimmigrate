...
function HeroBackground() {
  return (
    <div className="absolute top-0 w-full h-[100svh] bg-gradient-to-b from-opacity-[6.33%] dark:from-[#36924a] from-[#d1d1d1] to-opacity-[39.13%] dark:to-[#318250] to-[#51da61]">
      ...
      <HeroSvg className="md:w-full w-full h-[1200px] wave md:top-[100dvh] md:left-0 top-[520px] dark:text-[#18261b] text-[#2f8452]" />
    </div>
  );
}
